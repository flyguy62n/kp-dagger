"""Core network security scanner implementation."""

from pathlib import Path
from typing import Any

from network_security_scanner.core.database import DatabaseManager
from network_security_scanner.core.exceptions import (
    NetworkScannerError,
    UnsupportedDeviceError,
)
from network_security_scanner.models.base.enums import DeviceType, ReportFormat
from network_security_scanner.parsers.factory import ParserFactory
